...
export const preLoaderAnim = () => {
  const tl = gsap.timeline(); // Create a local timeline
  ...
  tl.to("body", {
    ...
    .to(
      ".preloader",
      {
        ...
        ease: "Power3.easeOut",
        onComplete: () => {
          // Hide the preloader and texts after the animation
          gsap.set(".preloader", { display: "none" });
          gsap.to(".texts-container", {
            duration: 0.5, // Fade out text faster
            opacity: 0,
            onComplete: () => {
              gsap.set(".texts-container", { display: "none" }); // Hide texts
            },
          });
        },
      },
...
export const fadeUp = (el, delay = 0, duration = 1) => {
  gsap.from(el, {
    y: 150,
    duration,
    delay,
